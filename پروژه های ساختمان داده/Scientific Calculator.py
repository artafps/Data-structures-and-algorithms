...
class Calculate:
    def __init__(self, equation:str):
        # الگوهای بازنویسی توابع ریاضی مانند cos، sin و log را تشخیص داده و جایگزین مقادیر حاصل شده می‌کند.
    ...
    def InfixToPostfix(self):
        # تابع تبدیل عبارت انفیکس به پستفیکس
        Operators = set(['+', '-', '*', '/', '(', ')', '^'])
        Priority = {'+':1, '-':1, '*':2, '/':2, '^':3}
        stack = Stack()
        output = []
    ...
    def compute(self):
        # تابع محاسبه ارزش عبارت پستفیکسی
        Operators = set(['+', '-', '*', '/', '^'])
...
# ---------- Main ----------#
# ایجاد یک شیء از کلاس Calculate با یک عبارت ریاضی
a = Calculate("3*cos(0)+cos(1)+sin(0)+log(2, 2)")
# چاپ نتیجه محاسبه
print(a.compute())

# ایجاد یک شیء دیگر از کلاس Calculate با یک عبارت ریاضی دیگر
b = Calculate("1+2*(3/(4+5))*6+cos(0)")
# چاپ نتیجه محاسبه
print(b.compute())
